...
#673056 3A6-NAc (temp_loc)
AnalDir0 = r"F:\photometry_FIPopt\230509\FIP_673056_2023-05-09_15-11-28"
AnalDir1 = r"F:\photometry_FIPopt\230509\FIP_673056_2023-05-09_15-39-38"
AnalDir2 = r"F:\photometry_FIPopt\230509\FIP_673056_2023-05-09_14-19-37"
AnalDir3 = r"F:\photometry_FIPopt\230509\FIP_673056_2023-05-09_14-47-14"
...
#AnalDir1 = r"F:\photometry_FIPopt\230509\FIP_664631_2023-05-09_19-40-02"
#AnalDir2 = r"F:\photometry_FIPopt\230509\FIP_664631_2023-05-09_18-16-06"
#AnalDir3 = r"F:\photometry_FIPopt\230509\FIP_664631_2023-05-09_18-40-17"
...
for ii_dir in range(len(AnalDirAll)):
    ...
    plt.ylabel('dF/F (%)')
    plt.title("SubjectID: " + os.path.basename(AnalDir))
    plt.legend()
    ...
    plt.savefig(SaveDir + os.sep + os.path.basename(AnalDir)[2:] +"_Fiber_" + str(FiberROI) + ".pdf")
...
plt.xlabel('Time (s)')
plt.ylabel('dF/F (%)')
plt.title("SubjectID: " + os.path.basename(AnalDir0))
plt.legend()
plt.xlim([0, time_seconds[-1]])
plt.grid(True)
